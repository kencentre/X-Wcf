...
namespace OracleDAL
{
    public class Desk : E_IDAL.IDesk
    {
        ...
        public DataSet GetSearchList(string strWhere, string startDate, string endDate)
        {
            ...
            {
                strSql.Append(" and SYS_DESK.createdate between to_date('" + startDate + " 00:00:00','yyyy-MM-dd hh24:mi:ss') and to_date('" + DateTime.Now.ToShortDateString() + " 23:59:59','yyyy-MM-dd hh24:mi:ss')");
            }
            if (startDate == "" && endDate != "")
            {
