...
var preview = {
	...
	getVedioHtml: function (data) {
		...
		sHtml += '	<video height="90%" width="100%" controls="controls" autoplay="autoplay">';
	    sHtml += '      <source src="' + vID + '" type="video/mp4">';
		sHtml += '  </video>';

		/*sHtml += '  <object height="100%" width="100%" classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95"> ';
		sHtml += '    <param name="AutoStart" value="1" />';
		sHtml += '    <param name="FileName" value="' + vID + '" />';
		sHtml += '    <embed src="' + vID + '" quality="high" width="100%" height="100%" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash"></embed>';
		sHtml += '  </object>';
		sHtml += '</div>';*/
		return sHtml;
	},
