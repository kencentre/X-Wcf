$(function() {
	        ...
	        success: function (data) {
	            ...
	            for (var i = 0, l = json.length; i < l; i++) {
	                ...
	                if (type == 0 || type == 1)
	                {
	                    if(l==0)
				{
					applist += "<li class='l_line'>";
	                   
	                    applist += "<a href=\"../" + json[i].NEWSURL + "\"><img class=\"" + previewClass + "\" src=\"../" + json[i].IMAGESHOW + "\" width=\"380\" height=\"380\" /></a>";
	                    applist += "<p class='news_content'><a href=\"../" + json[i].NEWSURL + "\">" + json[i].TITLE + "</a><span><a href=\"../" + json[i].NEWSURL + "\"><span style='color:#ffffff'>" + json[i].NEWSTEXT + "</span></a></span><span>" + json[i].CREATEDATE + "</span></p>";
	                    applist += "</li>";
	                    $(".jsTabCont").html(applist);
				}
	                        else
				{	
					applist += "<li class='line'>";
	                ...
	                if (type == 2 || type == 3)
                    {
	                    ...
	                    applist += "<div class='news_content'><a href=\"../" + json[i].NEWSURL + "\">" + json[i].TITLE + "</a></div>";
	                    applist += "</li>";
	            ...
	            if (type == 1) {
	                $("#photoNum").html("（" + totalRecord + "）");
	            } else if (type == 0) {
	                $("#videoNum").html("（" + totalRecord + "）");
	            }	            
    ...
    // 设置视频数量
	function setVedioNum() {
	    $.ajax({
	        type: "post",
	        url: "ajax.ashx",
	        data: "ac=GetNews&pindex=1&type=0",
	        //{
	        //    currentPage: currentPage,
	        //    pageSize: 10,
	        //    type: type
