<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" ValidateRequest="false" Inherits="X_Wcf.Administrator.CMSPlatform.Link.Modify" %>
                        ...
                        <Items>
                            <f:Form runat="server" ShowBorder="false" ShowHeader="false" >
                                <Rows>
                                    ...
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtUrl" runat="server" Label="地址" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                </Rows>
                            </f:Form>
