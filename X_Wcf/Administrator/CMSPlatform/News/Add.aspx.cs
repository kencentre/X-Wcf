    ...
    public partial class Add : BasePage
    {
        ...
        private string CreateHtml(string newschannel,string title,string createdate,string body,string brand,string image,string video)
        {
            ...
            if (input.Contains("$Video$"))
            {
                ...
                {
                    input = input.Replace("$Video$", "<div style='text-align:center'><video height='100% ' width='100%' controls='controls' autoplay='autoplay'><source  src = '../" + video + "' type='video/mp4'></video></div>");
                }
            }
