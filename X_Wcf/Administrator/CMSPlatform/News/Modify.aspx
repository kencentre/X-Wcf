<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" ValidateRequest="false" Inherits="X_Wcf.Administrator.CMSPlatform.News.Modify" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                <Items>
                            ...
                            <f:Form runat="server" ShowBorder="false" ShowHeader="false" >
                                <Rows>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtName" runat="server" Label="新闻标题" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtKeywords" runat="server" Label="关键字" ></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TriggerBox runat="server" ID="txtChannel" Label="新闻栏目" Required="true" ShowRedStar="true" TriggerIcon="Search"></f:TriggerBox>
                    ...
                    <f:GroupPanel runat="server" Title="缩略图" EnableCollapse="true">
                        <Items>
                    ...
                    <f:GroupPanel runat="server" Title="视频" EnableCollapse="true">
                        <Items>
                            <f:Toolbar runat="server">
                                <Items>
                                    <f:FileUpload ID="txtVideo" runat="server" ButtonIcon="DiskUpload"  AutoPostBack="true" OnFileSelected="txtVideo_FileSelected"></f:FileUpload>
