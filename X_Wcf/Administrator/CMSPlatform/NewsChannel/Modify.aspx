<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.CMSPlatform.NewsChannel.Modify" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" BodyPadding="6" ShowBorder="false" ShowHeader="false">
                <Items>
                    ...
                    <f:CheckBox runat="server" ID="cblStatus" Label="启停状态" ShowRedStar="true" Text="启用"></f:CheckBox>
