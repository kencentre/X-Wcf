<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="X_Wcf.Administrator.CMSPlatform.NewsChannel.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="FormPanel" runat="server">
            <Regions>
                <f:Region ID="LeftPanel" Title="栏目列表" ShowBorder="false" Layout="Fit" Position="Left" runat="server" RegionSplit="true" Width="300px">
                    <Items>
                ...
                <f:Region ID="CenterPanel" runat="server" ShowBorder="false" Title="栏目信息" Position="Center">
                    <Items>
                        <f:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="6" ShowBorder="false" ShowHeader="false">
                            <Items>
                                ...
                                <f:TextBox ID="txtChannelCode" runat="server" Label="栏目编码" Readonly="true"></f:TextBox>
                                <f:TriggerBox ID="txtParentID" runat="server" Label="上级栏目" TriggerIcon="Search" Readonly="true"></f:TriggerBox>
                                <f:HiddenField ID="txtParent" runat="server" Readonly="true"></f:HiddenField>
                                <f:NumberBox ID="txtMainList" runat="server" Label="菜单排序" Readonly="true"></f:NumberBox>
