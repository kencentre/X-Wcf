<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.BasePlatform.Account.Modify" %>
                        ...
                        <Items>
                            <f:GroupPanel ID="GroupPanel1" runat="server" Title="用户基本设置" EnableCollapse="True" BoxConfigAlign="Stretch" Layout="Anchor">
                                <Items>
                                    ...
                                    <f:TriggerBox ID="txtUserCode" runat="server" Label="用户工号" Required="true" ShowRedStar="true" TriggerIcon="Search" ></f:TriggerBox>
                        ...
                        <Items>
                            <f:GroupPanel ID="GroupPanel2" runat="server" Title="其他设置" EnableCollapse="True">
                                <Items>
                                    ...
                                    <f:TextBox ID="txtIDCard" runat="server" Label="身份证" RegexPattern="IDENTITY_CARD"></f:TextBox>
                                    <f:TextBox ID="txtPhone" runat="server" Label="联系电话"></f:TextBox>
                                    <f:TextBox ID="txtAdress" runat="server" Label="联系地址"></f:TextBox>
                                    <f:TextBox ID="txtMail" runat="server" Label="电子邮箱" RegexPattern="EMAIL"></f:TextBox>
