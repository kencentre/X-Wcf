<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.BasePlatform.Duty.Modify" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="FormPanel" runat="server" BodyPadding="6" ShowBorder="false" ShowHeader="false">
            <Items>
                <f:TextBox ID="txtDutyName" runat="server" Label="职务名称" Required="true" ShowRedStar="true" RequiredMessage="职务名称不能为空"></f:TextBox>
