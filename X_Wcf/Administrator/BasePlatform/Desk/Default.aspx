<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="X_Wcf.Administrator.BasePlatform.Desk.Default" %>
        ...
        <f:RegionPanel ID="RegionPanel1" runat="server" ShowBorder="false">
            <Regions>
                        ...
                        <f:Form runat="server" ShowBorder="false" BodyPadding="6" ShowHeader="false">
                            <Rows>
                                <f:FormRow runat="server">
                                    <Items>
                                        <f:TextBox ID="txtSearch" runat="server" Label="模块名称"></f:TextBox>
                ...
                <f:Region ID="Region2" runat="server" Position="Center" ShowHeader="true" Title="详细信息"
                    Layout="Fit">
                    <Items>
                        <f:Grid ID="Grid1" AllowPaging="true" runat="server" DataKeyNames="ID,STATUS,DESKCODE,DESKNAME" EnableCheckBoxSelect="True" ShowHeader="false" EnableAjax="true" Icon="TableGear" PageSize="10" Width="100%" IsDatabasePaging="true" CheckBoxSelectOnly="true" OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                <f:BoundField  DataField="DESKNAME" runat="server" Width="200px"  HeaderText="模块名称" />
                                <f:BoundField  DataField="DESKCODE" runat="server" Width="200px"  HeaderText="模块编码" />
                                <f:BoundField  DataField="DESCRIPTION" runat="server" HeaderText="简介"  ExpandUnusedSpace="true"/>
                ...
                DataIFrameUrlFormatString="Modify.aspx?id={0}" DataWindowTitleField="DESKNAME"
