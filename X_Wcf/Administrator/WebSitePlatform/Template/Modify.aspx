<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.WebSitePlatform.Template.Modify"  ValidateRequest="false" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                <Items>
                            ...
                            <f:Form runat="server" ShowBorder="false" ShowHeader="false" >
                                <Rows>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtName" runat="server" Label="模版名称" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                </Rows>
                            </f:Form>
                    ...
                    <f:GroupPanel runat="server" Title="上传模版" EnableCollapse="true">
                        <Items>
                    ...
                    <f:GroupPanel runat="server" Title="模版简介">
                        <Items>
