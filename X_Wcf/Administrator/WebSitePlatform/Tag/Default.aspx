<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="X_Wcf.Administrator.WebSitePlatform.Tag.dEFAULT" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" runat="server" ShowBorder="false">
            <Regions>
                        ...
                        <f:Form runat="server" ShowBorder="false" BodyPadding="6" ShowHeader="false">
                            <Rows>
                                <f:FormRow runat="server">
                                    <Items>
                                        <f:TextBox ID="txtSearch" runat="server" Label="标签名称"></f:TextBox>
                ...
                <f:Region ID="Region2" runat="server" Position="Center" ShowHeader="true" Title="详细信息"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" AllowPaging="true" runat="server" DataKeyNames="ID,STATUS" EnableCheckBoxSelect="True" ShowHeader="false" EnableAjax="true" Icon="TableGear" PageSize="10" Width="100%" IsDatabasePaging="true" CheckBoxSelectOnly="true" OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                <f:BoundField  DataField="TAGNAEM" runat="server" Width="200px"  HeaderText="标签名称" />
                                <f:BoundField  DataField="BROCKNAME" runat="server" HeaderText="所属模版"  ExpandUnusedSpace="true"/>
                ...
                DataIFrameUrlFormatString="Modify.aspx?id={0}" DataWindowTitleField="TAGNAME"
                DataWindowTitleFormatString="编辑 - {0}" />
                                <f:WindowField Width="60px" WindowID="windowSourceCode" HeaderText="配置"
                Icon="PageEdit" ToolTip="配置" DataTextFormatString="{0}" DataIFrameUrlFields="ID"
                DataIFrameUrlFormatString="Config.aspx?id={0}" DataWindowTitleField="TAGNAEM"
                DataWindowTitleFormatString="编辑 - {0}" />
                               <f:LinkButtonField Icon="PageFind" runat="server" CommandName="Approval" HeaderText="启用/停止" ToolTip="启用/停止" ID="lbfApproval" Width="90px" ConfirmText="启用/停止选中行？" ConfirmTarget="Top" />
                            ...
                            <Toolbars>
                                <f:Toolbar runat="server">
                                    <Items>
                                        ...
                                        <f:Button ID="btnApproval" Text="全部启用" runat="server" Icon="PageFind" OnClick="btnApproval_Click"></f:Button>
