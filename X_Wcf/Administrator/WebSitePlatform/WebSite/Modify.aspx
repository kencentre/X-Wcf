<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.WebSitePlatform.WebSite.Modify" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" BodyPadding="6" ShowBorder="false" ShowHeader="false">
                <Items>
                    ...
                    <f:HiddenField ID="txtTepmlate" runat="server" Readonly="true"></f:HiddenField>
