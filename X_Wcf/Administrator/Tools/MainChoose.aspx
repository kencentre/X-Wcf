<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainChoose.aspx.cs" Inherits="X_Wcf.Administrator.Administrator.Tools.MainChoose" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <f:Panel ID="FormPanel" runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                <Items>
                    <f:Tree runat="server" ID="tvList" ShowHeader="false" ShowBorder="false"></f:Tree>
                </Items>
                <Toolbars>
