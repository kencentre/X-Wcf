<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="X_Wcf.Administrator.SchoolPlatform.Teacher.Add" ValidateRequest="false" %>
                    ...
                    <f:GroupPanel runat="server" Title="基本信息设置">
                        <Items>
                            ...
                            <f:TextBox ID="txtEName" runat="server" Label="英文昵称" Required="true" ShowRedStar="true"></f:TextBox>
                                    ...
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextArea ID="txtRank"  runat="server" Label="头衔" Required="true" ShowRedStar="true" AutoGrowHeight="true"></f:TextArea>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow runat="server">
                                        <Items>
