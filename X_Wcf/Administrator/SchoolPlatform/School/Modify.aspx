<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.SchoolPlatform.School.Modify"  ValidateRequest="false" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                <Items>
                            ...
                            <f:Form runat="server" ShowBorder="false" ShowHeader="false" >
                                <Rows>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtSchoolName" runat="server" Label="校区名称" Required="true" ShowRedStar="true"></f:TextBox>
                            <f:TextBox ID="txtEName" runat="server" Label="英文名称" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtADress" runat="server" Label="校区地址" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                </Rows>
                            </f:Form>
                    ...
                    <f:GroupPanel runat="server" Title="展示图片" EnableCollapse="true">
                        <Items>
                            <f:Toolbar runat="server">
                                <Items>
                                    ...
                                    <f:Button Icon="Cancel" runat="server" ID ="btnPictureClear" Text="清空"></f:Button>
                    ...
                    <f:GroupPanel runat="server" Title="标题图片">
                        <Items>
                            <f:Toolbar runat="server">
                                <Items>
                                    <f:FileUpload ID="txtImage" runat="server" ButtonIcon="DiskUpload"  AutoPostBack="true" OnFileSelected="txtImage_FileSelected"></f:FileUpload>
                                    <f:Button Icon="Cancel" runat="server" ID ="btnImageClear" Text="清空"></f:Button>
                                    <f:Label runat="server" ID="lblIURL" Hidden="true"></f:Label>
                                </Items>
                            </f:Toolbar>
                            <f:Image runat="server" ID ="imgImage" Width="100" Height="40" Hidden="true"></f:Image>
                        </Items>
                    </f:GroupPanel>
                    <f:GroupPanel runat="server" Title="学校简介">
                        <Items>
