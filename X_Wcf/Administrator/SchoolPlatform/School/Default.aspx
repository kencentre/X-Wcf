<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="X_Wcf.Administrator.SchoolPlatform.School.Default" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" runat="server" ShowBorder="false">
            <Regions>
                        ...
                        <f:Form runat="server" ShowBorder="false" BodyPadding="6" ShowHeader="false">
                            <Rows>
                                <f:FormRow runat="server">
                                    <Items>
                                        <f:TextBox ID="txtSearch" runat="server" Label="校区名称"></f:TextBox>
                ...
                <f:Region ID="Region2" runat="server" Position="Center" ShowHeader="true" Title="详细信息"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" AllowPaging="true" runat="server" DataKeyNames="ID,STATUS" EnableCheckBoxSelect="True" ShowHeader="false" EnableAjax="true" Icon="TableGear" PageSize="10" Width="100%" IsDatabasePaging="true" CheckBoxSelectOnly="true" OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange" OnRowDataBound="Grid1_RowDataBound">
                            <Columns>
                                <f:BoundField  DataField="SCHOOLNAME" runat="server" Width="200px"  HeaderText="校区名称" />
                                <f:BoundField  DataField="SCHOOLENAME" runat="server" Width="200px"  HeaderText="英文名称" />
                                <f:BoundField  DataField="SCHOOLADRESS" runat="server" HeaderText="校区地址"  ExpandUnusedSpace="true"/>
                ...
                DataIFrameUrlFormatString="Modify.aspx?id={0}" DataWindowTitleField="SCHOOLENAME"
