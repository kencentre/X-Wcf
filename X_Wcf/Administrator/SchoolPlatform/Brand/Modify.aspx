<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="X_Wcf.Administrator.SchoolPlatform.Brand.Modify" ValidateRequest="false" %>
        ...
        <div>
            ...
            <f:SimpleForm ID="FormPanel" runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true">
                <Items>
                            ...
                            <f:Form runat="server" ShowBorder="false" ShowHeader="false" >
                                <Rows>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtName" runat="server" Label="品牌名称" Required="true" ShowRedStar="true"></f:TextBox>
                            <f:TextBox ID="txtEName" runat="server" Label="英文名称" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                    <f:FormRow runat="server">
                                        <Items>
                                            <f:TextBox ID="txtSlogan" runat="server" Label="标语" Required="true" ShowRedStar="true"></f:TextBox>
                                        </Items>
                                    </f:FormRow>
                                </Rows>
                            </f:Form>
                    ...
                    <f:GroupPanel runat="server" Title="品牌简介">
                        <Items>
