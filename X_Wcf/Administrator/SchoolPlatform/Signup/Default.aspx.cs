...
namespace X_Wcf.Administrator.SchoolPlatform.Signup
{
    public partial class Default : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                btnAdd.OnClientClick = windowSourceCode.GetShowReference("Add.aspx", "添加报名信息");
        ...
        protected void Grid1_RowDataBound(object sender, FineUI.GridRowEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                {
                    e.Values[3] = "<span style='color:red'>未处理</span>";
                }
                if (e.Values[3].ToString() == "1")
                {
                    e.Values[3] = "<span style='color:green'>已处理</span>";
                }
            }
