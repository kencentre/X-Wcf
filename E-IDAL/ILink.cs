...
namespace E_IDAL
{
    ...
    public interface ILink
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.Link model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.Link model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.Link GetModel(string ID);

        [OperationContract]
        E_Model.Link DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
