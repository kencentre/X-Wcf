...
namespace E_IDAL
{
    [ServiceContract(Name = "ITemplate")]
    public interface ITemplate
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.Template model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.Template model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.Template GetModel(string ID);

        [OperationContract]
        E_Model.Template DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
