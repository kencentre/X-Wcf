...
namespace E_IDAL
{
    ...
    public interface ISignup
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.Signup model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.Signup model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.Signup GetModel(string ID);

        [OperationContract]
        E_Model.Signup DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
