...
namespace E_IDAL
{
    ...
    public interface IAbout
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.About model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.About model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.About GetModel(string ID);

        [OperationContract]
        E_Model.About DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
