...
namespace E_IDAL
{
    ...
    public interface IStudent
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.Student model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.Student model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.Student GetModel(string ID);

        [OperationContract]
        E_Model.Student DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
