...
namespace E_IDAL
{
    ...
    public interface IECode
    {
        ...
        /// </summary>
        [OperationContract]
        bool Add(E_Model.ECode model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        [OperationContract]
        bool Update(E_Model.ECode model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        [OperationContract]
        ...
        /// </summary>
        [OperationContract]
        E_Model.ECode GetModel(string ID);

        [OperationContract]
        E_Model.ECode DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        [OperationContract]
