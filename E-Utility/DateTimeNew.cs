...
namespace E_Utility
{
    public class DateTimeNew
    {
        ...
        public static string ShortDate
        {
            get
            {
                return Now.ToString(E_Utility.Config.DateFormat);
            }
        }
        /// <summary>
        /// 长日期格式(yyyy月MM日dd日)
        ...
        public static string ShortDateTime
        {
            get
            {
                return Now.ToString(E_Utility.Config.DateTimeFormat);
            }
        }
        /// <summary>
        ...
        public static string ShortDateTimeS
        {
            get
            {
                return Now.ToString(E_Utility.Config.DateTimeFormatS);
            }
        }
        /// <summary>
