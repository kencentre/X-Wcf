...
public static class MyExtensions
{
    ...
    {
        return E_Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return E_Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return E_Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return E_Utility.EncryptionDes.Decrypt(str);
    }
    ...
    {
        return date.ToDateTime().ToString(E_Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(E_Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(E_Utility.Config.DateTimeFormatS);
    }

    public static string ToDateString(this DateTime date)
    {
        return date.ToString(E_Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this DateTime dateTime)
    {
        return dateTime.ToString(E_Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this DateTime dateTime)
    {
        return dateTime.ToString(E_Utility.Config.DateTimeFormatS);
    }
}
