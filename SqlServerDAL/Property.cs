...
{
    public class Property:E_IDAL.IProperty
    {
        public Property()
        { }
        ...
        public bool Add(E_Model.Property model)
        {
            ...
            strSql.Append("insert into CMS_PROPERTY(");
            strSql.Append("ID,PROPERTYNAME,PROPERTYTYPE,DESCRIPTION,CREATEDATE,CREATEUSER)");
            ...
            db.AddInParameter(dbCommand, "PROPERTYNAME", DbType.AnsiString, model.PROPERTYNAME);
            db.AddInParameter(dbCommand, "PROPERTYTYPE", DbType.AnsiString, model.PROPERTYTYPE);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CMS_PROPERTY set ");
        ...
        public bool Delete(string ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CMS_PROPERTY ");
            strSql.Append(" where ID=@ID ");
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
        ...
        public E_Model.Property GetModel(string ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from CMS_PROPERTY ");
            strSql.Append(" where ID=@ID ");
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
            db.AddInParameter(dbCommand, "ID", DbType.AnsiString, ID);
            E_Model.Property model = null;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM CMS_PROPERTY ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string startDate, string endDate, string startIndex, string endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from CMS_PROPERTY T where 1=1  ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" AND PROPERTYNAME like '%" + strWhere + "%' ");
            }
        ...
        /// </summary>
        public List<E_Model.Property> GetListArray(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM CMS_PROPERTY ");
            ...
            List<E_Model.Property> list = new List<E_Model.Property>();
            Database db = DatabaseFactory.CreateDatabase();
        ...
        /// 对象实体绑定数据
        /// </summary>
        public E_Model.Property ReaderBind(IDataReader dataReader)
        {
            E_Model.Property model = new E_Model.Property();
            object ojb;
            model.ID = dataReader["ID"].ToString();
            model.PROPERTYNAME = dataReader["PROPERTYNAME"].ToString();
            model.PROPERTYTYPE = dataReader["PROPERTYTYPE"].ToString();
