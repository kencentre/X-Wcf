...
{
    public class Template:E_IDAL.ITemplate
    {
        public Template()
        { }
        ...
        public bool Add(E_Model.Template model)
        {
            ...
            strSql.Append("insert into CMS_TEMPLATE(");
            strSql.Append("ID,TEMPLATENAME,TEMPLATEURL,STATUS,DESCRIPTION,CREATEDATE,CREATEUSER)");
            ...
            db.AddInParameter(dbCommand, "TEMPLATENAME", DbType.AnsiString, model.TEMPLATENAME);
            db.AddInParameter(dbCommand, "TEMPLATEURL", DbType.AnsiString, model.TEMPLATEURL);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CMS_TEMPLATE set ");
        ...
        public bool Delete(string ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CMS_TEMPLATE ");
            strSql.Append(" where ID=@ID ");
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
        ...
        public E_Model.Template GetModel(string ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,TEMPLATENAME,TEMPLATEURL,STATUS,DESCRIPTION,CREATEDATE,CREATEUSER from CMS_TEMPLATE ");
            strSql.Append(" where ID=@ID ");
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
            db.AddInParameter(dbCommand, "ID", DbType.AnsiString, ID);
            E_Model.Template model = null;
        ...
        public E_Model.Template DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["TEMPLATEURL"] != null)
                {
                    model.TEMPLATEURL = row["TEMPLATEURL"].ToString();
                }
                if (row["STATUS"] != null)
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,TEMPLATENAME,TEMPLATEURL,STATUS,DESCRIPTION,CREATEDATE,CREATEUSER ");
            strSql.Append(" FROM CMS_TEMPLATE ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string startDate, string endDate, string startIndex, string endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from CMS_TEMPLATE T where 1=1  ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" AND TEMPLATENAME like '%" + strWhere + "%' ");
            }
        ...
        /// </summary>
        public List<E_Model.Template> GetListArray(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,TEMPLATENAME,TEMPLATEURL,STATUS,DESCRIPTION,CREATEDATE,CREATEUSER ");
            strSql.Append(" FROM CMS_TEMPLATE ");
            ...
            List<E_Model.Template> list = new List<E_Model.Template>();
            Database db = DatabaseFactory.CreateDatabase();
        ...
        /// 对象实体绑定数据
        /// </summary>
        public E_Model.Template ReaderBind(IDataReader dataReader)
        {
            E_Model.Template model = new E_Model.Template();
            object ojb;
            model.ID = dataReader["ID"].ToString();
            model.TEMPLATENAME = dataReader["TEMPLATENAME"].ToString();
            model.TEMPLATEURL = dataReader["TEMPLATEURL"].ToString();
